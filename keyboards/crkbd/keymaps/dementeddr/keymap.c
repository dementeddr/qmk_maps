...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     KC_ESC,  KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,                         TO(0),   KC_J,    KC_K,    KC_L,    KC_SCLN,  TO(0),
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
     KC_LCTL, KC_LCTL, KC_X,    KC_C,    KC_NO,   KC_B,                         TO(0),   TO(0),   TO(0),   TO(0),   KC_RCTL, KC_RCTL,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                         KC_K,   KC_SPACE, KC_H,       KC_ENT,  KC_SPC,  MO(FUNC) 
                                      //`--------------------------'  `--------------------------'
  )
};
